...
export const PrimaryButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className="inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-lg bg-main-600 px-3 sm:px-4 py-2 text-sm font-semibold text-white hover:bg-main-700"
    >
      {icon && <Plus size={16} />}
      {children}
    </button>
