    ...
    <div className="w-full flex flex-col h-full">
      ...
      <div className="sticky top-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm z-10 pb-4 -mx-6 px-6 pt-1">
        ...
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className="dark:text-white">Roles</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center overflow-y-auto">
        <h1 className="text-2xl font-bold text-gray-700 dark:text-gray-200">Roles</h1>
      </div>
    </div>
  )
}

export default RolesViewTemplate
